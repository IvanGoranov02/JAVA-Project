...
@REM Use extracted class files directly - no jar file needed  
set WRAPPER_CLASSPATH=%MAVEN_PROJECTBASEDIR%\.mvn\wrapper
cd /d "%MAVEN_PROJECTBASEDIR%"
"%JAVA_HOME%\bin\java.exe" -Dmaven.multiModuleProjectDirectory="%MAVEN_PROJECTBASEDIR%" -cp "%WRAPPER_CLASSPATH%" org.apache.maven.wrapper.MavenWrapperMain %MAVEN_CMD_LINE_ARGS%
